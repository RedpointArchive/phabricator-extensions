...
final class DrydockWindowsAlmanacServiceHostBlueprintImplementation
  ...
  public function getBlueprintName() {
    return pht('Almanac Hosts (Windows)');
  }
  ...
  public function getDescription() {
    return pht(
      ...
      'pool (where the hosts are running Windows).');
  }
  ...
  public function getInterface(
    ...
    switch ($type) {
      case DrydockCommandInterface::INTERFACE_TYPE:
        ...
        return id(new DrydockWindowsSSHCommandInterface())
